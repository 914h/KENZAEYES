        ...
        <main>
            ...
            <div class="container page" id="page" style="margin-top: 100px;">
                <div class="entete-list">
                    <h1 class="display-4">Liste des facture</h1>
                    <span class="nbr">
                ...
                <table id="example" class="table  table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_assoc($res)) {
                            $id = $data['idfacture'];
                            echo "<tr>";
                            echo "<td>" . $data['idfacture'];
                            echo "<td>" . $data['idclient'];
                            echo "<td>" . $data['datefacture'];
                            echo "<td>" . $data['totalht'];
                            echo "<td>" . $data['totaltva'];
                            echo "<td>" . $data['totalttc'];
                            echo "<td>" . $data['statut'];
                            echo "<td>" . $data['datepaiement'];
                            echo "<td>" . $data['modepaiement'];
                            echo "<td>" . $data['notes'];
                            echo "<td> <a href=facture-form-update.php?id=" . urlencode($id) . " data-bs-toggle='tooltip' title='Modifier cette ligne'><i class='fa-solid fa-pencil'></i></a>";

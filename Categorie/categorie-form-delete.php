	...
	<div class="row">
		<div class="datadelete col-6">
			<fieldset>
				...
				<label>Id</label>
				<input type="text" name="idservice" value="<?php echo $data['idc']; ?>" class="form-control" disabled>
				<input type="text" name="id" value="<?php echo $data['idc']; ?>" hidden>
				<label>Nom</label>
				<input type="text" name="nomservice" value="<?php echo $data['titreC']; ?>" class="form-control" disabled>
			</fieldset>
		</div>
